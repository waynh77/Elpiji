...
Begin VB.Form F25_EditByrJual 
   BackColor       =   &H00808000&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "EDIT PEMBAYARAN PENJUALAN"
   ClientHeight    =   4050
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6945
   ClipControls    =   0   'False
   Icon            =   "F25_EditByrJual.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4050
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "F25_EditByrJual.frx":3482
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "F25_EditByrJual.frx":4E14
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.CommandButton Command1 
      BackColor       =   &H0080FF80&
      Caption         =   "KELUAR"
      DownPicture     =   "F25_EditByrJual.frx":67AC
      Height          =   855
      Index           =   2
      Left            =   5760
      Picture         =   "F25_EditByrJual.frx":7476
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   2040
      Width           =   1095
   ...
   Begin VB.CommandButton Command1 
      BackColor       =   &H0080FF80&
      Caption         =   "HAPUS"
      DownPicture     =   "F25_EditByrJual.frx":8140
      Height          =   855
      Index           =   1
      Left            =   5760
      Picture         =   "F25_EditByrJual.frx":8E0A
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   1080
      Width           =   1095
   ...
   Begin VB.CommandButton Command1 
      BackColor       =   &H0080FF80&
      Caption         =   "EDIT"
      DownPicture     =   "F25_EditByrJual.frx":9AD4
      Height          =   855
      Index           =   0
      Left            =   5760
      Picture         =   "F25_EditByrJual.frx":A79E
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   120
      Width           =   1095
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "F25_EditByrJual.frx":C120
      Height          =   2055
      Left            =   120
      OleObjectBlob   =   "F25_EditByrJual.frx":C134
      TabIndex        =   1
      Top             =   4080
      Width           =   6735
   End
   ...
   End
End
Attribute VB_Name = "F25_EditByrJual"
        ...
        If Not Data1.Recordset.BOF Then
            ...
            If x = vbYes Then
                ...
                With F11_TBayar.Data1.Recordset
                    ...
                    If !jumlah_bayar < !qty_jual * !harga_satuan Then
                        !status_bayar = False
                    Else
                        !status_bayar = True
                    End If
...
Else
    With Data1.Recordset
        ...
        .Update
    End With
    With F11_TBayar.Data4.Recordset
        .Edit
